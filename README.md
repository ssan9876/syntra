...
|---|---|---|
| **Core** | built | Multi-tenancy, directory, persons and contracts, RBAC, audit log, secrets vault, scheduler, notifications with webhook endpoints for Automate, Govern and security events, an optional Prometheus endpoint, web console. Users, groups, org units and people can be created, edited and deactivated from the console — never deleted |
