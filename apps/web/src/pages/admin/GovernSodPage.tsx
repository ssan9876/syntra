  ...
  return (
    <>
      <PageHeader
        ...
        description="A rule relates two BUSINESS FUNCTIONS, never two entitlements. A rule written directly over two Active Directory groups is wrong within a year and wrong invisibly."
      />
      ...
      <div className="mt-6 space-y-6">
        <Panel
          ...
          description="What somebody can DO, across every system that lets them do it."
        >
        ...
        <Panel
          title="Rules"
          description="Two functions that must not be held together, with the reason written down."
        >
        ...
        <Panel
          title="Violations"
          description="One row per person per rule, across every account and every system they hold."
        >
