    ...
    render(
      <StructureChanges
        actions={[
          ...
          { id: 'a2', actionType: 'create_container', status: 'proposed', after: { dn: `OU=ssander.local,${ROOT}` }, person: null },
          {
            id: 'a3',
            actionType: 'move_container',
            status: 'proposed',
            after: { fromDn: `OU=IT,${ROOT}`, dn: `OU=IT,OU=ssander.local,${ROOT}`, accounts: ['anna.novak', 'bo.lind'] },
            person: null,
          },
          {
            id: 'a4',
            ...
            status: 'proposed',
            before: { container: 'CN=Users,DC=ssander,DC=local' },
