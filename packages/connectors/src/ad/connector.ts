 ...
 * `FakeTarget` can split a DN the way a directory does without importing a
 * connector. Re-exported here unchanged: they were exported from this module
 * and the package root re-exports this module, so nothing importing them
 * moves.
 */
export { escapeDnValue, splitDn } from '../ldap/dn.js';
